    ...
    <div className="min-h-[82vh] bg-gray-100 flex flex-col items-center justify-center py-4 relative">
      ...
      <div className="w-full max-w-3xl bg-white rounded-lg shadow-md p-8 mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl text-[#8c1c13] text-[24px]">SOBRE EL PLAN</h2>
          <button
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          ...
          <div className="col-span-3 md:col-span-1">
            <label className="block text-gray-700 font-semibold mb-2" style={{ fontSize: '20px' }}>Nombre del Plan:</label>
            <input
              type="text"
          ...
          {/* Fecha de Inicio */}
          <div className="col-span-3 md:col-span-1">
            <label className="block text-gray-700 font-semibold mb-2" style={{ fontSize: '20px' }}>Fecha de Inicio:</label>
          ...
          {/* Fecha de Fin */}
          <div className="col-span-3 md:col-span-1">
            <label className="block text-gray-700 font-semibold mb-2" style={{ fontSize: '20px' }}>Fecha de Fin:</label>
            <div className="relative">
              <input
                type="date"
                className="w-full px-3 py-2 border rounded-lg bg-gray-200 text-gray-800 focus:outline-none"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {/* Proteínas */}
          <div>
            <label className="block text-[#4b4f57] font-semibold mb-2" style={{ fontSize: '20px' }}>Proteínas</label>
            <input
              type="text"
              className="w-full px-3 py-2 border rounded-lg bg-gray-200 text-gray-800 focus:outline-none"
            />
          ...
          {/* Carbohidratos */}
          <div>
            <label className="block text-[#4b4f57] font-semibold mb-2" style={{ fontSize: '20px' }}>Carbohidratos</label>
            <input
              type="text"
              className="w-full px-3 py-2 border rounded-lg bg-gray-200 text-gray-800 focus:outline-none"
            />
          ...
          {/* Grasas */}
          <div>
            <label className="block text-[#4b4f57] font-semibold mb-2" style={{ fontSize: '20px' }}>Grasas</label>
            <input
              type="text"
              className="w-full px-3 py-2 border rounded-lg bg-gray-200 text-gray-800 focus:outline-none"
            />
          ...
          {/* Calorías Diarias */}
          <div>
            <label className="block text-[#4b4f57] font-semibold mb-2" style={{ fontSize: '20px' }}>Calorías Diarias</label>
            <input
              type="text"
              className="w-full px-3 py-2 border rounded-lg bg-gray-200 text-gray-800 focus:outline-none"
            />
